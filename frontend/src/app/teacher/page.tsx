...
export default async function TeacherDashboard() {
  ...
  const weakStudents = data.weakStudents;

  return (
    <div className="p-8 min-h-screen bg-gray-50">
      <h1 className="text-4xl font-bold mb-8 text-gray-800 text-center">Teacher Dashboard</h1>
      <h2 className="text-2xl font-semibold mb-6 text-gray-700 text-center">Weak Students</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center max-w-6xl mx-auto">
        {weakStudents.map((student: any) => (
          <TiltedCard
            key={student.id}
            imageSrc={`https://images.unsplash.com/photo-1517673132405-a56a62b18caf?q=80&w=300&h=300&auto=format&fit=crop`}
