    ...
    <div className="flex min-h-screen max-w-7xl mx-auto p-6 gap-6 relative z-10 w-full">
      <aside className="w-64 bg-slate-50/80 dark:bg-zinc-900/80 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-zinc-800 h-fit p-6 shadow-sm">
        ...
        <nav className="flex flex-col gap-2">
          <Link href="/student/profile" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 font-medium transition-all duration-200 ease-in-out hover:bg-slate-200/50 hover:scale-[1.02] active:scale-95">
